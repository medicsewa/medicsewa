const PrivacyPage = () => {
  return (
    <main className="w-[80%] min-w-[680px] py-8 mx-auto">
      <h1>Privacy Policy for Medic Sewa Pvt. Ltd.</h1>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          our app, such as message history, clicks on ads, and other in-app
          activity.
        </li>
        <li>
          <strong>Device Information:</strong> IP address, browser type, device
          type, operating system, and other technical data.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <strong>To Comply with Legal Requirements:</strong> To meet any legal
          obligations or government requests.
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>WhatsApp:</strong> As the app integrates with WhatsApp, your
          contact information and messages will be shared with WhatsApp to
          facilitate communications.
        </li>
        <li>
          <strong>Service Providers:</strong> We may use third-party services
          (e.g., hosting providers, analytics services) that process your data
      ...
      <p>
        ...
        the purposes outlined in this Privacy Policy. Afterward, we will
        securely delete or anonymize your data in accordance with applicable
        laws.
      </p>
